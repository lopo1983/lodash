...
;(function() {
  ...
  function runInContext(context) {
     ...
     * `indexBy`, `initial`, `intersection`, `invert`, `invoke`, `keys`, `keysIn`,
     * `map`, `mapValues`, `matches`, `memoize`, `merge`, `mixin`, `negate`, `noop`,
     * `omit`, `once`, `pairs`, `partial`, `partialRight`, `partition`, `pick`,
     * `plant`, `pluck`, `property`, `propertyOf`, `pull`, `pullAt`, `push`, `range`,
     * `rearg`, `reject`, `remove`, `rest`, `reverse`, `shuffle`, `slice`, `sort`,
     * `sortBy`, `sortByAll`, `splice`, `spread`, `take`, `takeRight`, `takeRightWhile`,
